...
| **HackerNews**| [HackerNews](https://hackernews-from-api.netlify.app/news) |The Hacker News Interface aims to provide an engaging user experience by displaying the latest news from Hacker News (https://hackernews-from-api.netlify.app/). This project consists of two primary pages: the Main Page and the News Detail Page. |**React, TypeScript, Mui/material, Redux, RTK, React Router, Vite, Html-react-parser, Eslint, SPA** |
